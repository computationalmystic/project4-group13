...
function getRepoGroupPullRate() {
    $.get("https://cors-anywhere.herokuapp.com/http://augur.osshealth.io:5000/api/unstable/repo-groups", function(repodata, status){
        ...
        repoGroups.forEach((e) => {
            ...
            $.get("https://cors-anywhere.herokuapp.com/http://augur.osshealth.io:5000/api/unstable/repo-groups/" + e.repo_group_id + "/pull-request-acceptance-rate?begin_date="+ newBeginDate + "&end_date=" + newEndDate, function(pullRate) {
