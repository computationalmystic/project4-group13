...
function getRepoGroupNewContributors() {
    $.get("https://augur.osshealth.io:5000/api/unstable/repo-groups", function(repodata, status){
        ...
        repoGroups.forEach((e) => {
            ...
            $.get("https://augur.osshealth.io:5000/api/unstable/repo-groups/" + e.repo_group_id + "/contributors-new?period=week&begin_date="+ newBeginDate + "&end_date=" + newEndDate, function(newContributors) {
